...
<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><?php _e( _t( 'NSLC Setup' ) ); ?></li>
</ul>

<h3><?php _e( _t( 'NSLC Setup' ) ); ?></h3>
<div class="innerLR">
				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							<label class="control-label"><font color="red">*</font> <?php _e( _t( 'Branch' ) ); ?></label>
							<div class="controls">
                    ...
                    <div class="span6">
                        ...
                        <!-- Group -->
                        <div class="control-group">
                            <label class="control-label"><font color="red">*</font> <?php _e( _t( 'Term Start Date' ) ); ?></label>
                            <div class="controls">
                        ...
                        <!-- Group -->
                        <div class="control-group">
                            <label class="control-label"><font color="red">*</font> <?php _e( _t( 'Term End Date' ) ); ?></label>
                            <div class="controls">
