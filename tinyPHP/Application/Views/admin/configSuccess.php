...
header("Refresh: 2;". BASE_URL . 'admin/config/');
		...
		<div class="widget-body">
				...
				<div class="row-fluid">
					...
					<div class="alert alert-success">
						<strong><?php _e( _t( 'Success!' ) ); ?></strong> <?php _e( _t( 'Your system\'s configuration was saved successfully. You will be redirected in a few seconds.' ) ); ?>
					</div>
					<!-- // Alert END -->
