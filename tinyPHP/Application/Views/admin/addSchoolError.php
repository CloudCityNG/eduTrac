		...
		<div class="widget-body">
				...
				<div class="row-fluid">
					...
					<div class="alert alert-error">
						<strong><?php _e( _t( 'Error!' ) ); ?></strong> <?php _e( _t( 'An error occurred while trying to add a new school. Please click the back button and try again.' ) ); ?>
					</div>
					<!-- // Alert END -->
