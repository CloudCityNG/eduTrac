...
header("Refresh: 2;". BASE_URL . 'admin/edit_student/'.isGetSet('stu'));
		...
		<div class="widget-body">
				...
				<div class="row-fluid">
					...
					<div class="alert alert-success">
						<strong><?php _e( _t( 'Success!' ) ); ?></strong> <?php _e( _t( 'The student\s record was updated successfully; you will be redirected to the previous edit page.' ) ); ?>
					</div>
					<!-- // Alert END -->
