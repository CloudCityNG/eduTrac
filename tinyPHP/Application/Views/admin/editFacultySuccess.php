...
header("Refresh: 2;". BASE_URL . 'admin/edit_faculty/'.isGetSet('fac'));
		...
		<div class="widget-body">
				...
				<div class="row-fluid">
					...
					<div class="alert alert-success">
						<strong><?php _e( _t( 'Success!' ) ); ?></strong> <?php _e( _t( 'The faculty member was edited successfully; you will be redirected to the faculty edit page.' ) ); ?>
					</div>
					<!-- // Alert END -->
