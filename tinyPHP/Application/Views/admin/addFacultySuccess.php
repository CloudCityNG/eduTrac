...
header("Refresh: 2;". BASE_URL . 'admin/manage_faculty/');
		...
		<div class="widget-body">
				...
				<div class="row-fluid">
					...
					<div class="alert alert-success">
						<strong><?php _e( _t( 'Success!' ) ); ?></strong> <?php _e( _t( 'The faculty member was added successfully. You will now be redirected to the faculty page.' ) ); ?>
					</div>
					<!-- // Alert END -->
