				...
				<div class="row-fluid">
					...
					<div class="span6">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="grade" value="<?=_h($this->viewAcadCred[0]['grade']);?>" class="span3 center" />
                            </div>
                        </div>
                        <!-- // Group END -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-append date" id="datetimepicker6">
                                    <input id="statusDate" name="statusDate" value="<?=_h($this->viewAcadCred[0]['statusDate']);?>" type="text" required/>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-append bootstrap-timepicker">
                                    <input id="timepicker1" type="text" name="statusTime" class="input-small" value="<?=_h($this->viewAcadCred[0]['statusTime']);?>" required /><span class="add-on"><i class="icon-time"></i></span>
                                </div>
                            </div>
                        </div>
                        <!-- // Group END -->
