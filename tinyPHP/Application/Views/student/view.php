                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span3" type="text" readonly value="<?=_h($this->student[0]['address1']);?> <?=_h($this->student[0]['address2']);?>" />
                                <input class="span3" type="text" readonly value="<?=_h($this->student[0]['city']);?>" />
                                <input class="span3" type="text" readonly value="<?=_h($this->student[0]['state']);?>" />
                                <input class="span3" type="text" readonly value="<?=_h($this->student[0]['zip']);?>" />
                            </div>
                        </div>
                        <!-- // Group END -->
                    ...
                    <div class="span3">
                        ...
                        <!-- Group -->
                        <div class="control-group">
                            <label class="control-label" for="acadProg"><?php _e( _t( 'Academic Program' ) ); ?></label>
                            <div class="controls">
                                <input class="span4" type="text" readonly value="<?=_h($v['progCode']);?>" />
                    ...
                    <div class="span3">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <input class="span3 center" type="text" name="antGradDate" value="<?=_h($this->student[0]['antGradDate']);?>" required />
                            </div>
                        </div>
                        <!-- // Group END -->
