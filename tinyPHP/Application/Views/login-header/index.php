...
?>
<!DOCTYPE html>
<!--[if lt IE 7]> <html class="ie lt-ie9 lt-ie8 lt-ie7 fluid"> <![endif]-->
<!--[if IE 7]>    <html class="ie lt-ie9 lt-ie8 fluid sticky-top"> <![endif]-->
<!--[if IE 8]>    <html class="ie lt-ie9 fluid sticky-top"> <![endif]-->
<!--[if gt IE 8]> <html class="ie gt-ie8 fluid sticky-top"> <![endif]-->
<!--[if !IE]><!--><html class="fluid sticky-top"><!-- <![endif]-->
<head>
	...
	<link href="<?=BASE_URL;?>static/common/theme/css/style-default.css?1371788391" rel="stylesheet" type="text/css" />
