		...
		<div class="widget-body">
				...
				<div class="row-fluid">
					...
					<div class="alert alert-error center">
						<strong><?php _e( _t( 'Error!' ) ); ?></strong> <?php _e( _t( 'The system was unable to write your update to the database. Please go back, try again, or contact your system administrator if the problem persists.' ) ); ?>
					</div>
					<!-- // Alert END -->
