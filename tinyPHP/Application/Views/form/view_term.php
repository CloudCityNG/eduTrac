		...
		<div class="widget widget-heading-simple widget-body-gray">
			...
			<div class="widget-body">
				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="termName" name="termName" type="text" value="<?=_h($this->term[0]['termName']);?>" required /></div>
						</div>
						<!-- // Group END -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls"><input class="span12" id="reportingTerm" name="reportingTerm" type="text" value="<?=_h($this->term[0]['reportingTerm']);?>" required /></div>
                        </div>
                        <!-- // Group END -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-append date" id="datetimepicker6">
                                    <input id="termStartDate" name="termStartDate" type="text" value="<?=_h($this->term[0]['termStartDate']);?>" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<div class="input-append date" id="datetimepicker7">
						    		<input id="termEndDate" name="termEndDate" type="text" value="<?=_h($this->term[0]['termEndDate']);?>" />
				    				<span class="add-on"><i class="icon-th"></i></span>
								</div>
							</div>
						</div>
				...
				<div class="form-actions">
					<input name="termID" type="hidden" value="<?=_h($this->term[0]['termID']);?>" />
