				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="subjCode" readonly name="subjCode" type="text" value="<?=_h($this->subj[0]['subjCode']);?>" required /></div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="subjName" name="subjName" type="text" value="<?=_h($this->subj[0]['subjName']);?>" required /></div>
						</div>
						<!-- // Group END -->
