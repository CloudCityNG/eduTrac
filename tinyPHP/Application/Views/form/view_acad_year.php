				...
				<div class="row-fluid">
					...
					<div class="span8">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls"><input class="span12" id="acadYearDesc" name="acadYearDesc" type="text" value="<?=_h($this->acadYear[0]['acadYearDesc']);?>" required /> <br />example: 2012/13 Academic Year</div>
                        </div>
                        <!-- // Group END -->
