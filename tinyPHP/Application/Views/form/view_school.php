				...
				<div class="row-fluid">
					...
					<div class="span12">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls"><input class="span12" id="schoolName" name="schoolName" type="text" value="<?=$this->school[0]['schoolName'];?>" required /></div>
                        </div>
                        <!-- // Group END -->
						...
						<div class="control-group">
							...
							<div class="controls">
								<select style="width:100%" name="buildingCode" id="select2_10">
									<option value="">&nbsp;</option>
                            		<?php table_dropdown('building', 'buildingCode', 'buildingName',$this->school[0]['buildingCode']); ?>
                            	</select>
							</div>
						</div>
						<!-- // Group END -->
