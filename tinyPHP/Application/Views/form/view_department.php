		...
		<div class="widget widget-heading-simple widget-body-gray">
			...
			<div class="widget-body">
				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="deptName" name="deptName" type="text" value="<?=_h($this->dept[0]['deptName']);?>" required /></div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="deptDesc" name="deptDesc" type="text" value="<?=_h($this->dept[0]['deptDesc']);?>" /></div>
						</div>
						<!-- // Group END -->
				...
				<div class="form-actions">
					...
					<button type="submit" class="btn btn-icon btn-primary glyphicons circle_ok"><i></i><?php _e( _t( 'Update' ) ); ?></button>
				</div>
				<!-- // Form actions END -->
