...
<div class="innerLR">
	...
	<!-- Form -->
	<form class="form-horizontal margin-none" action="<?=BASE_URL;?>form/runEditBuilding/" id="validateSubmitForm" method="post" autocomplete="off">
				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="buildingCode" readonly name="buildingCode" type="text" value="<?=_h($this->build[0]['buildingCode']);?>" required /></div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="buildingName" name="buildingName" type="text" value="<?=_h($this->build[0]['buildingName']);?>" required /></div>
						</div>
						<!-- // Group END -->
