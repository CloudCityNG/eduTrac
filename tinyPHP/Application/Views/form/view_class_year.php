				...
				<div class="row-fluid">
                    ...
                    <div class="span6">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls"><input class="span12" id="minCredits" name="minCredits" type="text" value="<?=_h($this->year[0]['minCredits']);?>" required /></div>
                        </div>
                        <!-- // Group END -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls"><input class="span12" id="maxCredits" name="maxCredits" type="text" value="<?=_h($this->year[0]['maxCredits']);?>" required /></div>
                        </div>
                        <!-- // Group END -->
