				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls">
							    <select style="width:50%;" name="facID" id="select2_10" required>
							        <option value="">&nbsp;</option>
						...
						<div class="control-group">
							...
							<div class="controls">
								<select style="width:35%;" name="secType" id="select2_11" required>
									<option value="">&nbsp;</option>
					...
					<div class="span6">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="contactHours" value="<?=_h($this->addnl[0]['contactHours']);?>" class="span10" required />
                            </div>
                        </div>
                        <!-- // Group END -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="instructorLoad" value="<?=_h($this->addnl[0]['instructorLoad']);?>" class="span10" required />
                            </div>
                        </div>
                        <!-- // Group END -->
