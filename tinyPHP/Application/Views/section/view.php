...
$sec = new \tinyPHP\Classes\DBObjects\Course;
				...
				<div class="row-fluid">
					...
					<div class="span6">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-append date" id="datetimepicker6">
                                    <input id="startDate" name="startDate" type="text" value="<?=_h($this->sec[0]['startDate']);?>" required />
                                    <span class="add-on"><i class="icon-th"></i></span>
                                </div>
                                
                                <div class="input-append date" id="datetimepicker7">
                                    <input id="endDate" name="endDate" type="text" value="<?=_h($this->sec[0]['endDate']);?>" required />
                                    <span class="add-on"><i class="icon-th"></i></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="minCredit" class="span4" value="<?=_h($this->sec[0]['minCredit']);?>" required/>
                                <input type="text" name="maxCredit" class="span4" value="<?=_h($this->sec[0]['maxCredit']);?>" required/>
                                <input type="text" name="increCredit" class="span4" value="<?=_h($this->sec[0]['increCredit']);?>" required/>
                            </div>
                        </div>
                        <!-- // Group END -->
