...
$courseList = new \tinyPHP\Classes\DBObjects\Course;
				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls">
                            	<input type="text" id="select2_course" name="preReq" value="<?=_h($this->addnl[0]['preReq']);?>" class="span10" />
							</div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group">
							...
							<div class="controls">
								<select style="width:25%;" name="allowAudit" id="select2_11" required>
									<option value="">&nbsp;</option>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select style="width:25%;" name="allowWaitlist" id="select2_12" required>
                                    <option value="">&nbsp;</option>
					...
					<div class="span6">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="minEnroll" value="<?=_h((int)$this->addnl[0]['minEnroll']);?>" class="span10" required />
                            </div>
                        </div>
                        <!-- // Group END -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="seatCap" value="<?=_h((int)$this->addnl[0]['seatCap']);?>" class="span10" required />
                            </div>
                        </div>
                        <!-- // Group END -->
