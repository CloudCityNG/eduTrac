				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="address1" class="span10" value="<?=_h($this->addr[0]['address1']);?>" required />
							</div>
						</div>
						<!-- // Group END -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="address2" class="span5" value="<?=_h($this->addr[0]['address2']);?>" />
                            </div>
                        </div>
                        <!-- // Group END -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="city" class="span5" value="<?=_h($this->addr[0]['city']);?>" required />
                            </div>
                        </div>
                        <!-- // Group END -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="state" class="span2" value="<?=_h($this->addr[0]['state']);?>" required /><br />(i.e. enter SC for South Carolina)
                            </div>
                        </div>
                        <!-- // Group END -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="zip" class="span5" value="<?=_h($this->addr[0]['zip']);?>" required />
                            </div>
                        </div>
                        <!-- // Group END -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-append date" id="datetimepicker6">
                                    <input id="startDate" name="startDate" type="text" value="<?=_h($this->addr[0]['startDate']);?>" required/>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-append date" id="datetimepicker7">
                                    ...
                                    <?php } else { ?>
                                    <input id="endDate" name="endDate" type="text" value="<?=_h($this->addr[0]['endDate']);?>" />
                                    <?php } ?>
                                    <span class="add-on"><i class="icon-th"></i></span>
                                </div>
                            </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span4">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="phone1" class="span8" value="<?=_h($this->addr[0]['phone1']);?>" />
                            </div>
                        </div>
                        <!-- // Group END -->
                    ...
                    <div class="span4">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="ext1" class="span8" value="<?=_h($this->addr[0]['ext1']);?>" />
                            </div>
                        </div>
                        <!-- // Group END -->
                ...
                <div class="row-fluid">
                    ...
                    <div class="span4">
                        ...
                        <div class="control-group">
                            <label class="control-label"><?php _e( _t( 'Phone' ) ); ?></label>
                            <div class="controls">
                                <input type="text" name="phone2" class="span8" value="<?=_h($this->addr[0]['phone2']);?>" />
                            </div>
                        </div>
                        <!-- // Group END -->
                    ...
                    <div class="span4">
                        ...
                        <div class="control-group">
                            ...
                            <label class="control-label"><?php _e( _t( 'Extension' ) ); ?></label>
                            <div class="controls">
                                <input type="text" name="ext2" class="span8" value="<?=_h($this->addr[0]['ext2']);?>" />
                            </div>
                        </div>
                        <!-- // Group END -->
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="email" name="email2" class="span6" value="<?=_h($this->addr[0]['email2']);?>" />
                            </div>
                        </div>
                        <!-- // Group END -->
