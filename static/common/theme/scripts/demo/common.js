...
$(function()
{
	...
	// typeahead
	if ($('[data-toggle="aScreen"]').length)
		$('[data-toggle="aScreen"]').typeahead({
	...
	// typeahead
	if ($('[data-toggle="fScreen"]').length)
		$('[data-toggle="fScreen"]').typeahead({
			source: ["SYSS - System Settings","MPERM - Manage Perms","APERM - Add Perm","MROLE - Manage Roles","AUDT - Audit Trail","SQL - SQL Terminal","MSCH - Manage Schools","ASCH - Add School"],
			items: 4,
			minLength: 2		
		});
	
	// typeahead
	if ($('[data-toggle="pScreen"]').length)
		$('[data-toggle="pScreen"]').typeahead({
			source: ["SYSS - System Settings","MPERM - Manage Perms","APERM - Add Perm","MROLE - Manage Roles","AUDT - Audit Trail","SQL - SQL Terminal","MSCH - Manage Schools","ASCH - Add School"],
			items: 4,
			minLength: 2		
		});
	...
	// typeahead
	if ($('[data-toggle="sScreen"]').length)
		$('[data-toggle="sScreen"]').typeahead({
			source: ["SYSS - System Settings","MPERM - Manage Perms","APERM - Add Perm","MROLE - Manage Roles","AUDT - Audit Trail","SQL - SQL Terminal","MSCH - Manage Schools","ASCH - Add School"],
			items: 4,
			minLength: 2		
		});
