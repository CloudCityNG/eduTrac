<?php namespace eduTrac\Classes\Libraries\elFinder;
...
abstract class elFinderVolumeDriver {
	...
	protected function mimetype($path) {
		...
		if ($this->mimeDetect == 'finfo') {
			...
			$type = \eduTrac\Classes\Libraries\elFinder\elFinderVolumeDriver::mimetypeInternalDetect($path);
		}
		...
		return $type == 'unknown' && $this->mimeDetect != 'internal'
			? \eduTrac\Classes\Libraries\elFinder\elFinderVolumeDriver::mimetypeInternalDetect($path)
			: $type;
	...
	static protected function mimetypeInternalDetect($path) {
		...
		return isset(\eduTrac\Classes\Libraries\elFinder\elFinderVolumeDriver::$mimetypes[$ext]) ? \eduTrac\Classes\Libraries\elFinder\elFinderVolumeDriver::$mimetypes[$ext] : 'unknown';
