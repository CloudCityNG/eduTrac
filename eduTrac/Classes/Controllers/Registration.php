...
class Registration extends \eduTrac\Classes\Core\Controller {
	...
	public function index() {
		$this->view->staticTitle = array(_t('Registration Settings'));
    ...
    public function runSetting() {
        $options =  [ 
                    ...
                    'account_balance','open_terms','registration_term','registrar_email_address',
                    'reg_instructions' 
                    ];
