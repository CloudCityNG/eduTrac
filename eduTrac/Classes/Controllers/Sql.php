...
class Sql extends \eduTrac\Classes\Core\Controller {

	public function __construct() {
		parent::__construct();
		if(!hasPermission('access_sql_interface_screen')) { redirect( BASE_URL . 'dashboard/' ); }
		/**
	...
	public function index() {
		$this->view->staticTitle = array(_t('SQL Terminal'));
