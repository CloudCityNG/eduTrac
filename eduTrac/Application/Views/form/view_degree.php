...
<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><a href="<?=BASE_URL;?>form/degree/<?=bm();?>" class="glyphicons pin_flag"><i></i> <?php _e( _t( 'Degree' ) ); ?></a></li>
	<li class="divider"></li>
	<li><?php _e( _t( 'View Degree' ) ); ?></li>
</ul>

<h3><?php _e( _t( 'View Degree' ) ); ?></h3>
<div class="innerLR">
				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="degreeCode"<?=gio();?> name="degreeCode" type="text" value="<?=_h($this->degree[0]['degreeCode']);?>" required /></div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="degreeName"<?=gio();?> name="degreeName" type="text" value="<?=_h($this->degree[0]['degreeName']);?>" required /></div>
						</div>
						<!-- // Group END -->
