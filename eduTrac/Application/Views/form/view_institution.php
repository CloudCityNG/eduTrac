				...
				<div class="row-fluid">
					...
					<div class="span6">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls"><input class="span12" id="ficeCode"<?=gio();?> name="ficeCode" type="text" value="<?=_h($this->inst[0]['ficeCode']);?>" required /></div>
                        </div>
                        <!-- // Group END -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls"><input class="span12" id="instName"<?=gio();?> name="instName" type="text" value="<?=_h($this->inst[0]['instName']);?>" required /></div>
                        </div>
                        <!-- // Group END -->
					...
					<div class="span6">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls"><input class="span12" id="city"<?=gio();?> name="city" type="text" value="<?=_h($this->inst[0]['city']);?>" /></div>
                        </div>
                        <!-- // Group END -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select style="width:100%" name="state" id="select2_10"<?=gio();?>>
                                    <option value="">&nbsp;</option>
