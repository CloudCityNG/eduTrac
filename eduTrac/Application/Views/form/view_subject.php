...
<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><a href="<?=BASE_URL;?>form/subject/<?=bm();?>" class="glyphicons pin_flag"><i></i> <?=_t( 'Subject' );?></a></li>
	<li class="divider"></li>
	<li><?=_t( 'View Subject' );?></li>
</ul>

<h3><?=_t( 'Viewing ' );?><?=_h($this->subj[0]['subjName']);?></h3>
<div class="innerLR">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-md-8"><input class="form-control"<?=gio();?> name="subjectCode" type="text" value="<?=_h($this->subj[0]['subjectCode']);?>" required /></div>
						</div>
						<!-- // Group END -->
						...
						<div class="form-group">
							...
							<div class="col-md-8"><input class="form-control"<?=gio();?> name="subjectName" type="text" value="<?=_h($this->subj[0]['subjectName']);?>" required /></div>
						</div>
						<!-- // Group END -->
