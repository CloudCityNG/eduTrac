				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="cipCode"<?=gio();?> name="cipCode" type="text" value="<?=_h($this->cip[0]['cipCode']);?>" required /></div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="cipName"<?=gio();?> name="cipName" type="text" value="<?=_h($this->cip[0]['cipName']);?>" required /></div>
						</div>
						<!-- // Group END -->
