...
<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><a href="<?=BASE_URL;?>form/major/<?=bm();?>" class="glyphicons pin_flag"><i></i> <?=_t( 'Major' );?></a></li>
	<li class="divider"></li>
	<li><?=_t( 'View Major' );?></li>
</ul>

<h3><?=_t( 'Viewing ' );?><?=_h($this->major[0]['majorName']);?></h3>
<div class="innerLR">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-md-8"><input class="form-control" id="majorCode"<?=gio();?> name="majorCode" type="text" value="<?=_h($this->major[0]['majorCode']);?>" required /></div>
						</div>
						<!-- // Group END -->
						...
						<div class="form-group">
							...
							<div class="col-md-8"><input class="form-control" id="majorName"<?=gio();?> name="majorName" type="text" value="<?=_h($this->major[0]['majorName']);?>" required /></div>
						</div>
						<!-- // Group END -->
