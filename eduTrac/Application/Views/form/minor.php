...
<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><?php _e( _t( 'Minor' ) ); ?></li>
</ul>

<h3><?php _e( _t( 'Minor' ) ); ?></h3>
<div class="innerLR">

	<!-- Form -->
	<form class="form-horizontal margin-none" action="<?=BASE_URL;?>form/runMinor/" id="validateSubmitForm" method="post" autocomplete="off">
				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="minorCode" name="minorCode" type="text" required /></div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="minorName" name="minorName" type="text" required /></div>
						</div>
						<!-- // Group END -->
        ...
        <div class="widget-body">
            ...
            <table class="dynamicTable tableTools table table-striped table-bordered table-condensed table-primary">
                ...
                <tr class="gradeX">
                    ...
                    <td class="center">
                        <a href="<?=BASE_URL;?>form/view_minor/<?=_h($value['minorID']);?>/<?=bm();?>" title="View Minor" class="btn btn-circle"><i class="icon-eye-open"></i></a>
                        <?php Hooks::do_action('search_minor_action'); ?>
                    </td>
                </tr>
                <?php } endif; ?>
