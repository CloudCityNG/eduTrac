...
<div class="innerLR">
	...
	<!-- Form -->
	<form class="form-horizontal margin-none" action="<?=BASE_URL;?>form/runStuLoadRule/" id="validateSubmitForm" method="post" autocomplete="off">
        ...
        <div class="widget-body">
            ...
            <table class="dynamicTable tableTools table table-striped table-bordered table-condensed table-primary">
                ...
                <tr class="gradeX">
                    ...
                    <td class="text-center"><?=_h($value['State']);?></td>
                    <td class="text-center">
                    	<div class="btn-group dropup">
                            ...
                            <ul role="menu" class="dropdown-menu dropup-text pull-right">
                                <li><a href="<?=BASE_URL; ?>form/view_student_load_rule/<?=_h($value['slrID']); ?>/<?=bm();?>"><?=_t( 'View' );?></a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
