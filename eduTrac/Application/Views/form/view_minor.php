...
<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><a href="<?=BASE_URL;?>form/minor/<?=bm();?>" class="glyphicons pin_flag"><i></i> <?=_t( 'Minor' );?></a></li>
	<li class="divider"></li>
	<li><?=_t( 'View Minor' );?></li>
</ul>

<h3><?=_t( 'Viewing ' );?><?=_h($this->minor[0]['minorName']);?></h3>
<div class="innerLR">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-md-8"><input class="form-control"<?=gio();?> name="minorCode" type="text" value="<?=_h($this->minor[0]['minorCode']);?>" required /></div>
						</div>
						<!-- // Group END -->
						...
						<div class="form-group">
							...
							<div class="col-md-8"><input class="form-control"<?=gio();?> name="minorName" type="text" value="<?=_h($this->minor[0]['minorName']);?>" required /></div>
						</div>
						<!-- // Group END -->
