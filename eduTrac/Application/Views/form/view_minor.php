				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="minorCode"<?=gio();?> name="minorCode" type="text" value="<?=_h($this->minor[0]['minorCode']);?>" required /></div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="minorName"<?=gio();?> name="minorName" type="text" value="<?=_h($this->minor[0]['minorName']);?>" required /></div>
						</div>
						<!-- // Group END -->
