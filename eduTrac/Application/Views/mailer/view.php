...
<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><?=_t( 'View Email Template' );?></li>
</ul>

<h3><?=_t( 'View Email Template' );?></h3>
<div class="innerLR">
		...
		<div class="widget widget-heading-simple widget-body-gray">
			...
			<div class="widget-body">
				...
				<div class="row">
					...
					<div class="col-md-10">
						...
						<div class="form-group">
							...
							<div class="col-md-8"><input class="form-control" id="email_key" name="email_key" type="text" value="<?=_h($this->emailTemp[0]['email_key']);?>" required/></div>
						</div>
						<!-- // Group END -->
						...
						<div class="form-group">
							...
							<div class="col-md-8"><input class="form-control" id="email_name" name="email_name" type="text" value="<?=_h($this->emailTemp[0]['email_name']);?>" required/></div>
						</div>
						<!-- // Group END -->
						...
						<div class="form-group row-fluid">
							<div class="form-group">
								...
								<div class="col-md-8">
									<textarea id="id1" class="wysihtml5 col-md-12 form-control" rows="20" name="email_value" required><?=_h($this->emailTemp[0]['email_value']);?></textarea>
								</div>
							</div>
						</div>
						<!-- // Group END -->
						...
						<!-- Group -->
						<div class="form-group">
							<label class="col-md-3 control-label" for="semester"><?=_t( 'Last Update' );?></label>
							<div class="col-md-6"><input class="form-control" type="text" disabled value="<?=date('D, M d, o @ h:i A',strtotime(_h($this->emailTemp[0]['LastUpdate'])));?>" /></div>
						</div>
						<!-- // Group END -->
				...
				<div class="form-actions">
					...
					<input name="deptCode" type="hidden" value="<?=_h($this->emailTemp[0]['deptCode']);?>" />
