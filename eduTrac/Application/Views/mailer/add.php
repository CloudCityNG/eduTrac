...
<h3><?php _e( _t( 'Add Email Template' ) ); ?></h3>
<div class="innerLR">
				...
				<div class="row-fluid">
					...
					<div class="span10">
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="email_key" name="email_key" type="text" required/></div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="email_name" name="email_name" type="text" required/></div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group row-fluid">
							<div class="control-group">
								...
								<div class="controls">
									<textarea id="id1" class="wysihtml5 span12" rows="20" name="email_value" required></textarea>
								</div>
							</div>
						</div>
						<!-- // Group END -->
