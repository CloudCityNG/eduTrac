				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-md-8"><input class="form-control" id="permName" name="permName" type="text" value="<?=$ePerm->getPermNameFromID(isGetSet('permID'));?>" required /></div>
						</div>
						<!-- // Group END -->
						...
						<div class="form-group">
							...
							<div class="col-md-8"><input class="form-control" id="permKey" name="permKey" type="text" value="<?=$ePerm->getPermKeyFromID(isGetSet('permID'));?>" required /></div>
						</div>
						<!-- // Group END -->
