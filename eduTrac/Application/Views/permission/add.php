...
<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><?php _e( _t( 'Add Permission' ) ); ?></li>
</ul>

<h3><?php _e( _t( 'Add Permission' ) ); ?></h3>
<div class="innerLR">
		...
		<div class="widget widget-heading-simple widget-body-gray">
			...
			<div class="widget-body">
				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="permName" name="permName" type="text" required /></div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="permKey" name="permKey" type="text" required /></div>
						</div>
						<!-- // Group END -->
				...
				<div class="form-actions">
					...
					<input type="hidden" name="permID" value="" />
