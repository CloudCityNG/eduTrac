				...
				<div class="widget widget-heading-simple widget-body-white margin-none">
					<div class="widget-body">
						...
						<div class="widget widget-heading-simple widget-body-simple text-right form-group">
							<form class="form-search text-center" action="<?=BASE_URL;?>hr/<?=bm();?>" method="post" autocomplete="off">
                    ...
                    <td class="text-center">
                        <div class="btn-group dropup">
                            ...
                            <ul role="menu" class="dropdown-menu dropup-text pull-right">
                                <li><a href="<?=BASE_URL;?>hr/view/<?=_h($v['staffID']);?>/<?=bm();?>"><?=_t( 'View' );?></a></li>
                                
                                <li><a href="<?=BASE_URL;?>hr/add/<?=_h($v['staffID']);?>/<?=bm();?>"><?=_t( 'Add Position' );?></a></li>
                                
                                <li><a href="<?=BASE_URL;?>hr/positions/<?=_h($v['staffID']);?>/<?=bm();?>"><?=_t( 'View Positions' );?></a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
