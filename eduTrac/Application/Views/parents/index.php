...
<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><?php _e( _t( 'Parent' ) ); ?></li>
</ul>

<h3><?php _e( _t( 'Search Parent' ) ); ?></h3>
<div class="innerLR">
	...
	<div class="widget widget-heading-simple widget-body-gray">
		<div class="widget-body">
				...
				<div class="widget widget-heading-simple widget-body-white margin-none">
					<div class="widget-body">
						...
						<div class="widget widget-heading-simple widget-body-simple text-right">
							<form class="form-search center" action="<?=BASE_URL;?>parents/<?=bm();?>" method="post" autocomplete="off">
							  	<input type="text" name="parent" class="input-xxlarge" placeholder="Search parent . . . " /> 
			...
			<table class="dynamicTable tableTools table table-striped table-bordered table-condensed table-white">
                ...
                <tr class="gradeX">
                    <td class="center"><?=_h($v['parentID']);?></td>
                    <td class="center"><?=_h($v['lname']);?></td>
                    <td class="center"><?=_h($v['fname']);?></td>
                    <td class="center">
                    	<a href="<?=BASE_URL;?>parents/view/<?=_h($v['parentID']);?>/<?=bm();?>" title="View Parent" class="btn btn-circle"><i class="icon-eye-open"></i></a>
                    </td>
                </tr>
				<?php } endif; ?>
				</tbody>
