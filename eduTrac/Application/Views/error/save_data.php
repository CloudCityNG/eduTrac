		...
		<div class="widget-body">
				...
				<div class="row-fluid">
					...
					<div class="alert alert-error center">
						<strong><?php _e( _t( 'Error!' ) ); ?></strong> <?php _e( _t( 'The system was unable to write your entry to the database. This error usually occurs when there were no changes made to a record, and you clicked the save button. If this is not the case, please go back, try again, or contact your system administrator if the problem persists.' ) ); ?>
					</div>
					<!-- // Alert END -->
