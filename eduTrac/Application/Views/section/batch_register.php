...
<div class="innerLR">
	...
	<div class="modal hide fade" id="myModal">
        <div class="modal-body">
            <p><?=_t('You can find the id of a course section by visiting the <a href="'.BASE_URL.'section/">search</a> screen for sections. The id is the first column in the table from the search result.');?></p>
        </div>
