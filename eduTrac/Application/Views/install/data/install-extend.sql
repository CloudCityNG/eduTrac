...
ALTER TABLE `stu_term_load` ADD FOREIGN KEY (`termID`) REFERENCES `stu_term` (`termID`) ON UPDATE CASCADE ON DELETE RESTRICT;
...
INSERT INTO `et_option` VALUES(1, 'dbversion', '00017');
...
INSERT INTO `staff` VALUES(1, '1', '', '', '', '', '', 'A', '{now}', '1', '');
