...
/**
 * Search General Journal Entries View
 *  
 * PHP 5.4+
 *
...
<ul class="breadcrumb">
    ...
    <li class="divider"></li>
    <li><?php _e( _t( 'Search Journal Entries' ) ); ?></li>
</ul>

<h3><?php _e( _t( 'Search Journal Entries' ) ); ?></h3>
<div class="innerLR">

    <!-- Form -->
    <form class="form-horizontal margin-none" action="<?=BASE_URL;?>financial/jentries/" id="validateSubmitForm" target="_blank" method="get" autocomplete="off">
