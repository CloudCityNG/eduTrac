<?php if(!defined('INST_BASEDIR')) die('Direct access is not allowed!');
    ...
    *  ================================================================= */
	...
	STEP_PHPREQUIRES => array(
		...
		'directives'  =>  true,
		'phpversion'  =>  '5.4.x', # minimum: 5.1.4
	...
	STEP_ADDEDINFO => array(
		...
		'form'        =>  array(						
			  array('type' => 'paragraph',
					'text' => 'The following options are required.'),
			  ...
			  array('type' => 'label',
					'text' => 'Site Installation URL'),
			  array('type' => 'textbox',
					'keyword'  => 'siteurl',
					'value'    => 'Make sure to include a trailing slash "/"',
					'numeric'  => false,
					'mustfill' => true,
					'minlen'   => false,
					'maxlen'   => false,
	...
	\--------------------------------------------------------------------*/
	'installer_title_name' => 'Install eduTrac',
